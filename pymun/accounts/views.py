...
@method_decorator(login_required, name='dispatch')
class ChangeMainEmailView(generic.edit.FormView):
    template_name = 'myaccount/change_main_email.html'
    form_class = forms.UpdateMainEmailForm
